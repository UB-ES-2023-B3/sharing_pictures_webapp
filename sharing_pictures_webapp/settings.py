...
BASE_DIR_FRONT = BASE_DIR/'frontend'
BASE_DIR_BACK = BASE_DIR/'backend'
...
ALLOWED_HOSTS = ['sharing-pictures.azurewebsites.net', 'sharing-pictures-dev.azurewebsites.net', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR_FRONT, 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR_FRONT/'src', 'media')