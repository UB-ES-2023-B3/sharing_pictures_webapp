    ...
    return (
      <ChakraProvider>
        <div style={styles.centeredContainer}>
            ...
            <div div style={styles.imageleft}>
              ...
              <Flex marginLeft="10px" marginRight='10px' justifyContent="space-between" >
                <Box width='100%'>
                  ...
                  {this.renderDescription(descriptionWithHashtags,hashtags)}

                  <Box paddingTop="5%" display="flex" alignItems="center">
                    <Avatar size="md" name="Christian Nwamba" src="https://bit.ly/code-beast" />
                    <Box ml="3">
                      <Button as="b" variant="link">
                        NOMBRE
                      </Button>
          ...
          <Modal isOpen={isReporting} onClose={this.closeReportModal}>
            <ModalOverlay />
            <ModalContent>
              <ModalHeader>Reportar Imagen</ModalHeader>
              <ModalCloseButton />
              <ModalBody>
                {reportSubmitted ? (
                  <Text>¡Gracias por tu reporte!</Text>
                ) : (
                  <>
                    <Select
                    ...
                    >
                      ...
                      <option value="violacion-de-derechos">Violación de derechos</option>
              ...
              <ModalFooter>
                {reportSubmitted ? (
                  <Button colorScheme="blue" onClick={this.closeReportModal}>
                    Cerrar
                  </Button>
                ) : (
                  <>
                    <Button colorScheme="blue" onClick={this.handleReportSubmit}>
                      Enviar Reporte
                    </Button>
                    <Button variant="ghost" onClick={this.closeReportModal}>
                      Cancelar
                    </Button>
                  </>
                )}
